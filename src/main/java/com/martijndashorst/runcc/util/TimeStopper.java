package com.martijndashorst.runcc.util;
...
public class TimeStopper {
	...
	/**
	 * Returns true if the timer is running, else it has been stopped or
	 * suspended.
	 */
	...
	/**
	 * Interrupt timer. Time gets saved. This method works if the timer was
	 * started or resumed before, else it does nothing.
	 */
	public void suspend() {
		if (isRunning()) {
	...
	/**
	 * Start again after interruption. Pause time will not be added. This method
	 * works if the timer was suspended before, else it does nothing.
	 */
	public void resume() {
		if (isRunning() == false)
	...
	/**
	 * Returns current time representation "HH:MM:SS". The timer will be stopped
	 * for calculation of time and then be resumed.
	 */
	...
	/**
	 * Returns current time representation in millisconds. The timer will be
	 * stopped for calculation and then be resumed.
	 */
