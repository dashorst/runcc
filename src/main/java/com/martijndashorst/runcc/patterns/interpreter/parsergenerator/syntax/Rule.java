...
/**
 * A rule is a list of String symbols on the right side and a nonterminal on the
 * left side: "a ::= b c d;" A nonterminal is represented as a String with no
 * quotes, every terminal must appear quoted by " or ' or ` (backquote).
 * 
...
public class Rule implements Serializable {
	...
	/**
	 * Constructing a rule from a String array, first element is interpreted as
	 * nonterminal.
	 */
	...
	/**
	 * Constructing a rule from a String List, first element is interpreted as
	 * nonterminal.
	 */
	public Rule(List symbols) {
		if (symbols == null)
			throw new IllegalArgumentException(
					"Can not construct rule without nonterminal: " + symbols);
