	...
	*/
		...
		throws Exception
	{
		...
		if (parserTables == null)	{
			...
			System.err.println("ParserTables scratch compilation took "+ts.getTimeMillis()+" millis");
		}
	...
	*/
	...
	public static void main(String [] args)	{
		try	{
			...
			Syntax syntax = new com.martijndashorst.runcc.patterns.interpreter.parsergenerator.syntax.builder.SyntaxBuilder(syntaxFile).getParserSyntax();
			com.martijndashorst.runcc.util.TimeStopper ts = new com.martijndashorst.runcc.util.TimeStopper();
