...
/**
 * Lexer result tree element, holding texts, its line/column range, and result
 * children.
 * 
...
public class ResultTree {
	...
	/**
	 * Returns the character- or byte-range within input where the token was
	 * found.
	 */
	...
	/**
	 * Returns the String text of this ResultTree, including any text of its
	 * children.
	 */
	@Override
		...
		if (stringResult == null) {
			...
			for (int i = 0; sequenceList != null && i < sequenceList.size(); i++) {
				...
				if (o instanceof ResultTree)
					...
					sb.append((StringBuffer) o); // is faster than o.toString()
			}
	...
	/**
	 * Returns the child at index i of this element, which could be StringBuffer
	 * or ResultTree.
	 */
	public Object getChild(int i) {
		Object o = sequenceList.get(i);
		return o instanceof StringBuffer ? o.toString() : o; // avoid
																// StringBuffer.append
																// calls
	}
